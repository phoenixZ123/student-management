...
router.delete("/delete-student",authenticate,studentController.deleteStudent.bind(studentController));
router.put("/update-student",authenticate,studentController.updateStudent.bind(studentController));
